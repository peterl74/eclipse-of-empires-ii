...
const App: React.FC = () => {
  ...
  return (
    <div className="h-screen bg-[#0b0a14] text-[#e2d9c5] font-sans flex flex-col overflow-hidden relative">
      ...
      <WelcomeModal onClose={() => {}} /> {/* The modal handles its own visibility logic via localStorage */}
      <HelpModal isOpen={showHelpModal} onClose={() => setShowHelpModal(false)} />// Inside the return div...
      <WelcomeModal onClose={() => {}} /> {/* The modal handles its own visibility logic via localStorage */}
      <HelpModal isOpen={showHelpModal} onClose={() => setShowHelpModal(false)} />
      
      {/* ... rest of your code ... */}// Inside the return div...
      <WelcomeModal onClose={() => {}} /> {/* The modal handles its own visibility logic via localStorage */}
      <HelpModal isOpen={showHelpModal} onClose={() => setShowHelpModal(false)} />
